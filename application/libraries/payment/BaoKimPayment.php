...
class BaoKimPayment 
{
	...
	// Mã merchante site 
	private $merchant_id = '31757';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = 'a0c702f7007f7840'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	...
	public function createRequestUrl($data)
	{
		...
		$currency = 'VND'; // USD
        $secure_pass = '8b64bcd131257ef3';
		$params = array(
			'merchant_id'		=>	strval($this->merchant_id),
			'order_id'			=>	strval('123333'),
			'business'			=>	strval('vietqmax@gmail.com'),
			'total_amount'		=>	strval('100000'),
			'shipping_fee'		=>  strval('0'),
			'tax_fee'			=>  strval('0'),
			'order_description'	=>	strval('mo ta'),
