...
class BaoKim_payment{
	...
	var $code 		= 'baokim';
	var $setting 	= array(
		'business' 				=> 'vietqmax@gmail.com',//tai khoan cua nguoi nhan tien
		'merchant_id' 			=> '31757',//id cua website khi dang ky ben baokim
		'secure_pass' 			=> '8b64bcd131257ef3',//mat khau giao tiep 8b64bcd131257ef3
		'cost_constant'			=> 1700,
		'cost_percent'			=> 1,
	);
	...
	//var $url 		= 'http://sandbox.baokim.vn/payment/order/version11';	
	...
	private function _bk_create_url($order_id, $business, $total_amount, $shipping_fee, $tax_fee, $order_description, $url_success, $url_cancel, $url_detail)
	{
		...
		// $params['checksum'] = strtoupper(md5($str_combined)); //cũ
