		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
				...
				<tr>
					<td colspan="7">
					     <div class="list_action itemActions">
								<a href="#submit" id="submit" class="button blueB" url="<?= admin_url('side/del_all')?>">
			...
			<tbody>
				...
				<tr class='row_<?= $row->id ?>'>
					...
					<td class="option">
					<a href="<?= admin_url('side/edit/'.$row->id) ?>" title="Chỉnh sửa" class="tipS "><img src="<?= public_url() ?>/admin/images/icons/color/edit.png" /></a>
					<a href="<?= admin_url('side/delete/'.$row->id) ?>" title="Xóa" class="tipS verify_action" ><img src="<?= public_url() ?>/admin/images/icons/color/delete.png" />
						</a>
					</td>
				</tr>
					...
					<td><span title="<?= $con->name; ?>" class="tipS"><?= '--|'.$con->name; ?></span></td>
					<td><span class="tipS">Cấp 2</span></td>
					<td><span title="<?= $con->sort_order ?>" class="tipS"><?= $con->sort_order; ?></span></td>
					<td class="option">
					<a href="<?= admin_url('side/edit/'.$con->id) ?>" title="Chỉnh sửa" class="tipS "><img src="<?= public_url() ?>/admin/images/icons/color/edit.png" /></a>
					<a href="<?= admin_url('side/delete/'.$con->id) ?>" title="Xóa" class="tipS verify_action" ><img src="<?= public_url() ?>/admin/images/icons/color/delete.png" /></a>
					</td>
					</tr>
						...
						<tr class='row_<?= $con1->id ?>'>
							...
							<td class="option">
								<a href="<?= admin_url('side/edit/'.$con1->id) ?>" title="Chỉnh sửa" class="tipS "><img src="<?= public_url() ?>/admin/images/icons/color/edit.png" /></a>
								<a href="<?= admin_url('side/delete/'.$con1->id) ?>" title="Xóa" class="tipS verify_action"><img src="<?= public_url() ?>/admin/images/icons/color/delete.png" /></a>
							</td>
						</tr>
						<?php endforeach;?>
						<?php endif;?>
