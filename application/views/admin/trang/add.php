        ...
        <div class="tab_container">
            ...
            <div id='tab2' class="tab_content pd0">
                ...
                <div class="formRow">
                    ...
                    <div class="formRight"><input name="slogan" type="text" value="<?=set_value('slogan')?>"/></div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label class="formLeft">Mô tả ngắn:</label>
                    <div class="formRight"><textarea name="intro" id="intro" class="editor" rows="5"><?=set_value('intro')?></textarea></div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
            ...
            <div id='tab3' class="tab_content pd0" <?php if($infosetting->ngonngu == 0):?> style="display: none;" <?php endif;?>>
                ...
                <div class="formRow">
                    <label class="formLeft">Slogan:</label>
                    <div class="formRight"><input name="slogan_en" type="text" value="<?=set_value('slogan_en')?>"/></div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
