		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
				...
				<tr>
					<td colspan="7">
						 <div class="list_action itemActions">
								<a href="#submit" id="submit" class="button blueB" url="<?= admin_url('ykien/del_all')?>">
			...
			<tbody class="list_item">
					...
					<div class="image_thumb">
						<img src="<?= base_url('uploads/images/slide/'.$row->image_link) ?>">
						<div class="clear"></div>
					</div>
					<a href="#" class="tipS" title="" target="_blank"><b><?= $row->name ?> </b></a>
					</td>
					<td class="textR">
						<p><?= $row->ykien;?></p>
					...
					<td class="option textC">
						<a href="<?= admin_url('ykien/edit/'.$row->id)?>" title="Chỉnh sửa" class="tipS">
							<img src="<?= public_url()?>admin/images/icons/color/edit.png" />
						</a>
						<a href="<?= admin_url('ykien/delete/'.$row->id)?>" title="Xóa" class="tipS verify_action" >
